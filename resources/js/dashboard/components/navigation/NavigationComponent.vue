<template>
  ...
  >
    <div
      class="text-white flex flex-col items-center justify-start mb-2"
      v-if="getLoggedUser"
    >
      <div class="my-5 flex flex-col items-center justify-start">
        ...
        <div class="mt-2 flex items-center justify-center gap-x-2">
          <form method="POST" action="/logout" class="flex items-center">
            ...
            <button type="submit">
              <svg
                class="fill-current text-red-600 hover:text-red-400"
                xmlns="http://www.w3.org/2000/svg"
        ...
        <ul class="mt-1">
          ...
          >
            <router-link
              ...
              "
              exact
              >Create reservation</router-link
            >
          </li>
        </ul>
      </div>
        ...
        <ul class="mt-1">
          ...
          >
            <router-link
              ...
              "
              exact
              >Create User Profile</router-link
            >
          </li>
        </ul>
      </div>
      ...
      <div class="pt-2">
        ...
        <ul class="mt-1">
          ...
          <li
            ...
            v-if="isAdmin || isLocationManager"
          >
            <router-link
              :to="{ name: 'AddProduct' }"
              class="
