<template>
  <FilterComponent @close="close">
    ...
    <template slot="header"> Users Filter </template>
    <div class="mt-5 px-3">
      <input
        id="id"
        name="id"
      ...
      <div class="mt-3 pb-2 border-b-2 border-sky-600">
        <div class="mb-2 text-base font-semibold">Roles</div>
        <div class="flex items-center flex-wrap gap-2">
          ...
          >
            <input
              ...
              @click="callFilter"
            />
            <label :for="role.name" class="text-sm capitalize">{{
              role.name
            }}</label>
          </div>
        </div>
      ...
      <div class="mt-3 pb-2 border-b-2 border-sky-600">
        ...
        <div class="flex flex-col items-start gap-3 md:flex-row">
          <div class="flex items-center">
            <label class="text-sm font-semibold mr-3" for="fromDate"
              >From:</label
            >
            <input
              type="date"
