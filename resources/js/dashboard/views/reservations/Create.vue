                ...
                <Input
                  ...
                  :class="{
                    ...
                    'border-green-600':
                      ...
                      !$v.client.phoneNumber.$error,
                  }"
                  @blur.native="callCheckForUser"
                />
              </form-group>
              <form-group
                :validator="$v.client.email"
                label="Email"
              ...
              >
                <Input
                  ...
                  :class="{
                    ...
                    'border-green-600':
                      $v.client.email.$dirty && !$v.client.email.$error,
                  }"
                />
              </form-group>
            </div>
              ...
              >
                <date-picker
                  ...
                  :input-class="{
                    ...
                    '!border-green-600':
                      $v.reservation.date.$dirty && !$v.reservation.date.$error,
                  }"
              ...
              >
                <date-picker
                  ...
                  :input-class="{
                    ...
                    '!border-green-600':
                      $v.reservation.time.$dirty && !$v.reservation.time.$error,
                  }"
                  @input="callCheckForAvailableTables"
                >
                </date-picker>
              ...
              >
                <Input
                  ...
                  :class="{
                    ...
                    'border-green-600':
                      $v.reservation.seats.$dirty &&
                      !$v.reservation.seats.$error,
                  }"
