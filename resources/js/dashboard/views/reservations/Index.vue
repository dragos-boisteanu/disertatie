<template>
	<view-container>
		<reservations-filter :filterData="filterData" v-if="showFilterState" @closed="toggleFilterState" @ @filter="filter">
		</reservations-filter>
		...
		<div v-else class="w-full h-full flex items-center justify-center">
			<spinner :size="90" :spacing="24" :line-size="7" :font-size="20" line-fg-color="#0084C7"></spinner>
		</div>
