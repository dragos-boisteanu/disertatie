<footer class="flex-none bg-gray-900 p-12">
	<div class="w-full grid grid-cols-2 gap-4 md:grid-cols-4">
		<div class="md:justify-self-center">
			...
			<ul class="text-trueGray-500 ml-1 text-sm">
				<li class="my-2">
					<a href="" class="hover:text-trueGray-300">
						Acasa
					</a>
				</li>
				<li class="my-2">
		...
		<div class="md:justify-self-center">
			...
			<ul class="text-trueGray-500 ml-1 text-sm">
				<li class="flex gap-x-2 items-center">
					...
					<a href="" class="hover:text-trueGray-300 my-1">
						Facebook
					</a>
				</li>
				<li class="flex gap-x-2 items-center  my-1">
					<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="16px" height="16px">
		...
		<div class="md:justify-self-center">
			...
			<ul class="text-trueGray-500 ml-1 text-sm">
				<li class="my-2">
					<span class="font-semibold text-trueGray-700">L - V:</span> <span class="text-trueGray-300">10:00</span>
					<span class="text-red-700"> / </span> <span class="text-trueGray-300">22:00</span>
				</li>
				<li class="my-2">
					<span class="font-semibold text-trueGray-700">S - D:</span> <span class="text-trueGray-300">12:00</span> <span
			...
			<ul class="text-trueGray-500 ml-1 text-sm">
				<li>
					...
					<ul class="ml-1 text-sm">
						...
						<li class="my-1">
							<span class="text-red-600">Vodafone</span> 1234567890
						</li>
						<li class="my-1">
				...
				<li>
					...
					<p class="ml-1 w-32 overflow-ellipsis">
	...
	<div class="w-full text-xs text-center mt-10 text-trueGray-200">
		Design and developed by <span>-NUME-</span>
	</div>
