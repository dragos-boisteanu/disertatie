						...
						<div class="col-start-3 col-end-11 w-full md:flex md:items-center">
							...
							<div class="md:border-l md:border-gray-30 md:flex-1">
								<div class="flex items-center justify-between p-2 border-gray-300">
									...
									<form class="flex-initial" method="POST" action="{{ route('carts.delete', ['id' => $item->id]) }}">
										@csrf
										@method("DELETE")
								...
								<div
									class="flex items-center border-t p-2 text-sm @if ($item->finalDiscount)  justify-between @else justify-evenly @endif ">
							...
							<ul class="flex items-center justify-between gap-x-2 py-2 px-4 text-sm text-trueGray-700">
								...
								<li>
									<input id="dm{{ $deliveryMethod->id }}" type="radio" name="deliveryMethodId"
										value="{{ $deliveryMethod->id }}" @if ($deliveryMethod->id == old('deliveryMethodId')) checked
									@endif @if ($deliveryMethod->isDisabled) disabled
									@endif
									/>
						...
						<ul
							...
							<li>
								<input id="pm{{ $paymentMethod->id }}" type="radio" name="paymentMethod"
									value="{{ $paymentMethod->id }}" @if ($paymentMethod->id == old('paymentMethod')) checked @endif
								@if ( $paymentMethod->isDisabled) disabled
								@endif />
