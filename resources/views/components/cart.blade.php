...
<div class="relative group rounded bg-trueGray-800 shadow-sm group-hover:rounded-none">
    <a class="relative block h-full w-full p-2" href="/">
        ...
        <svg class="fill-current text-white" xmlns="http://www.w3.org/2000/svg" height="18px" viewBox="0 0 24 24" width="18px">
