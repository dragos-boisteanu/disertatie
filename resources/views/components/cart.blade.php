...
<div class="relative group rounded bg-trueGray-800 shadow-sm group-hover:rounded-b-none">
    ...
    <div class="min-w-56 absolute -bottom-32 right-0 bg-white rounded-sm p-2 hidden group-hover:block">
        ...
        <div class="w-full text-center border-t- border-gray-800 pt-1 mt-1">
            <form method="GET" action="/">
                <button class="rounded-sm text-white bg-green-600 px-4">
                    Go to checkout
                </button>
            </form>
        </div>
